...
### सैंडबॉक्स बनाम प्रोजेक्ट प्रोसेसिंग**इंडेक्स/एलयूटी सैंडबॉक्स (इंटरएक्टिव):**

* एक समय में एकल छवि
* तत्काल प्रतिक्रिया
* प्रायोगिक एवं पुनरावृत्तीय
* फ़ाइलों में कोई स्थायी परिवर्तन नहीं
* अन्वेषण और परीक्षण के लिए बिल्कुल उपयुक्त

**परियोजना प्रसंस्करण (बैच):**

* संपूर्ण डेटासेट एक ही बार में
...
## इंडेक्स/एलयूटी सैंडबॉक्स के साथ कार्य करना
...
* **विज़ुअलाइज़ेशन सेटिंग्स समायोजित करें** इंटरैक्टिव ढंग से
* **देखें** पहले से ही गणना की गई सूचकांक छवियां
* सभी ज़ूम स्तरों पर पिक्सेल मानों का **निरीक्षण**करें

### सैंडबॉक्स खोलना

इंडेक्स/LUT सैंडबॉक्स को**इमेज व्यूअर**में एक्सेस किया जाता है<img src="../.gitbook/assets/icon_image-viewer.JPG" alt="" data-size="line">साइडबार टैब:

1. फ़ाइल ब्राउज़र छवि ग्रिड में एक छवि पर क्लिक करें, यह**छवि व्यूअर**में खुलता है<img src="../.gitbook/assets/icon_image-viewer.JPG" alt="" data-size="line">टैब
2.**इमेज व्यूअर**पर क्लिक करें<img src="../.gitbook/assets/icon_image-viewer.JPG" alt="" data-size="line">यदि बायां पॉप-आउट साइडबार पहले से खुला नहीं है तो उसे खोलने के लिए टैब पर क्लिक करें

### इंडेक्स/एलयूटी लागू करने के लिए एक छवि का चयन करना

इमेज व्यूअर में एक इंडेक्स के साथ काम करने के लिए<img src="../.gitbook/assets/icon_image-viewer.JPG" alt="" data-size="line">सैंडबॉक्स:

1.**एक छवि**पर क्लिक करके उसे मुख्य छवि ग्रिड से खोलें
2.**छवि दर्शक**<img src="../.gitbook/assets/icon_image-viewer.JPG" alt="" data-size="line">फिर टैब खुलेगा
3.**लेयर ड्रॉपडाउन** पर क्लिक करें (दर्शक के ऊपर दाईं ओर)
4. ड्रॉपडाउन से परत चुनें:
* रॉ (परावर्तन)

### किसी छवि पर अनुक्रमणिका लागू करना

एक बार छवि पूर्णस्क्रीन हो जाए और **छवि दर्शक**<img src="../.gitbook/assets/icon_image-viewer.JPG" alt="" data-size="line">टैब साइडबार खुला है:
...
7. अलग-अलग पिक्सेल और उनसे संबंधित मान देखने के लिए ज़ूम इन करें
...
संपूर्ण सूचकांक सूत्र दस्तावेज़ीकरण के लिए, [मल्टीस्पेक्ट्रल सूचकांक सूत्र](../project-settings/multispectral-index-formulas.md) देखें।***## LUTs (लुक-अप टेबल्स) के साथ कार्य करना
...
* **उद्देश्य**: पैटर्न को देखना और व्याख्या करना आसान बनाएं**ग्रेस्केल बनाम रंग LUT:**
...
1. क्लिक करें<img src="../.gitbook/assets/image.png" alt="" data-size="line">"+LUT जोड़ें" बटन
2. रंग ग्रेडिएंट का चयन करें
3. क्लिपिंग न्यूनतम/अधिकतम अंतिम बिंदुओं को समायोजित करें
4. क्लिपिंग मोड समायोजित करें
5.**इमेज व्यूअर**में इंडेक्स बॉक्स को चेक करें<img src="../.gitbook/assets/icon_image-viewer.JPG" alt="" data-size="line">

LUT लागू करने के लिए टैब साइडबार

### रंग ग्रेडियंट चुनना**एक ग्रेडिएंट का चयन करना:**1. LUT पैनल में,**रंगीन ग्रेडिएंट बार**का पता लगाएं
2. उपलब्ध ग्रेडिएंट प्रीसेट देखने के लिए उस पर अपना माउस घुमाएँ
3. वांछित ग्रेडिएंट का चयन करें
4. जब इंडेक्स बॉक्स चेक किया जाता है तो छवि नए रंगों के साथ**तुरंत अपडेट**हो जाती है

{% hint style="success" %}**सर्वोत्तम अभ्यास**: एनडीवीआई जैसे वनस्पति सूचकांकों के लिए, लाल-पीला-हरा ग्रेडिएंट सबसे सहज है क्योंकि यह प्राकृतिक रंग संघों (हरा = स्वस्थ, पीला = मध्यम, लाल = तनावग्रस्त) के साथ संरेखित होता है।
{% endhint %}

### रंग वर्गों का समायोजन**कक्षा नियंत्रण**यह निर्धारित करता है कि आपके ग्रेडिएंट में कितने अलग-अलग रंग चरण दिखाई देते हैं:**वर्ग गणना विकल्प:**
...
* **20+ कक्षाएं**: लगभग-निरंतर, अधिकतम चिकनाई**कैसे समायोजित करें:**1. LUT पैनल में,**ग्रेडिएंट बार के नीचे रंग स्वैच वर्ग**का पता लगाएं
2. + बटन से जोड़कर कक्षाओं की संख्या समायोजित करें
3. रंग नमूने पर डबल क्लिक करके कक्षाओं की संख्या निकालें
4. ग्रेडिएंट छवि पर**वास्तविक समय में**अपडेट होता है**विज़ुअलाइज़ेशन पर प्रभाव:**

* **कम कक्षाएं** (3-5): अलग-अलग क्षेत्र बनाता है, वर्गीकरण को सरल बनाता है, श्रेणियों को अलग करना आसान होता है
* **मध्यम कक्षा** (6-10): संतुलित दृष्टिकोण, अधिकांश अनुप्रयोगों के लिए अच्छा
* **अधिक कक्षाएं**(15-20): सहज बदलाव, विस्तृत विविधता, फोटोग्राफिक उपस्थिति**कब उपयोग करें:**
...
### फाइन-ट्यूनिंग वैल्यू रेंज**मान श्रेणी नियंत्रण**यह निर्धारित करते हैं कि कौन सा सूचकांक मान आपके ग्रेडिएंट में किन रंगों से मेल खाता है:**LUT पैनल में रेंज नियंत्रण:**
...
#### न्यूनतम/अधिकतम मान समायोजित करना**मूल्य श्रेणियों को समायोजित करने के लिए:**1. LUT पैनल में,**न्यूनतम मान**और**अधिकतम मान**इनपुट फ़ील्ड ढूंढें
2.**न्यूनतम मान**फ़ील्ड पर क्लिक करें
3. वांछित न्यूनतम मान टाइप करें (जैसे,`0.2`)
4.**Enter**दबाएँ या फ़ील्ड के बाहर क्लिक करें
5.**अधिकतम मान**फ़ील्ड के लिए दोहराएँ (उदा.,`0.9`)
6. विज़ुअलाइज़ेशन**तुरंत अपडेट होता है**{% hint style="info" %}**ऑटो-स्केलिंग**: जब आप पहली बार LUT लागू करते हैं, तो क्लोरोस स्वचालित रूप से छवि में वास्तविक डेटा रेंज पर न्यूनतम/अधिकतम सेट कर देता है। फिर आप रुचि की विशिष्ट मूल्य श्रेणियों पर ध्यान केंद्रित करने के लिए इस सीमा को सीमित कर सकते हैं।
{% endhint %}**उदाहरण एनडीवीआई रेंज समायोजन:**

* **पूरी श्रृंखला**:`-1.0` to `1.0`(सभी संभावित मान दिखाएँ)
* **वनस्पति-केंद्रित**:`0.2` to `0.9`(नंगी मिट्टी और पानी को छोड़कर)
* **केवल स्वस्थ वनस्पति**:`0.5` to `0.9`(केवल सशक्त पौधों को हाइलाइट करें)
* **तनाव का पता लगाना**:`0.2` to `0.5`(समस्या क्षेत्रों पर जोर दें)
* **कस्टम रेंज**: अपने देखे गए पिक्सेल मानों के आधार पर समायोजित करें**श्रेणियाँ समायोजित क्यों करें?**
...
* **एक संकीर्ण मूल्य सीमा के भीतर सूक्ष्म अंतरों पर जोर दें**### सीमा से बाहर के मानों को क्लिप करना
...
* **उपयोग का मामला**: चरम सीमाओं पर जोर दें, सीमा पर संतृप्त रंगों के साथ पूर्ण डेटा रेंज दिखाएं
* **उदाहरण**: 0.2 से नीचे एनडीवीआई मान सभी लाल दिखाई देते हैं, 0.9 से ऊपर सभी मान हरे दिखाई देते हैं

#### 2. पारदर्शी पृष्ठभूमि

* **सीमा के बाहर**के पिक्सेल**पूरी तरह से पारदर्शी** हो जाते हैं
* केवल **सीमा के भीतर** पिक्सेल ही रंग ढाल दिखाते हैं
* **उपयोग का मामला**: जीआईएस ओवरले, विशिष्ट मूल्य श्रेणियों को अलग करना, केवल रुचि के क्षेत्रों को उजागर करना
* **उदाहरण**: केवल NDVI 0.4-0.7 रंग में दिखाएं, बाकी सब पारदर्शी

{% hint style="warning" %}**पारदर्शिता सीमा**: पारदर्शी पिक्सेल व्यूअर में पृष्ठभूमि रंग के रूप में दिखाई देंगे। जब प्रसंस्करण के दौरान निर्यात किया जाता है, तो पारदर्शिता पीएनजी प्रारूप में संरक्षित होती है लेकिन जेपीजी में नहीं।
{% endhint %}
...
* **उपयोग का मामला**: सूक्ष्म हाइलाइटिंग, रुचि के क्षेत्रों पर जोर देते हुए संदर्भ बनाए रखें
...
| क्लिपिंग मोड              | के लिए सर्वोत्तम                                   | विज़ुअलाइज़ेशन शैली          |
| ---------------------- | ------------------------------------------------ | -------------------------------- |
|**न्यूनतम और अधिकतम**| पूर्ण डेटा प्रदर्शन, वैज्ञानिक विश्लेषण     | सभी पिक्सेल रंगीन           |
|**पारदर्शी पृष्ठभूमि**| जीआईएस ओवरले, विशिष्ट श्रेणियों को अलग करता है    | रेंज पर रंग, परे खाली |
|**सूचकांक पृष्ठभूमि**| सूक्ष्म जोर, डेटा संदर्भ को बनाए रखना  | सीमा पर रंग, परे धूसर  |
|**मूल पृष्ठभूमि**| रिपोर्टें, प्रस्तुतियाँ, सहज विश्लेषण | रेंज पर रंग, परे फोटो |

### कस्टम LUT रंग बनाना

अपने विज़ुअलाइज़ेशन पर पूर्ण नियंत्रण के लिए, आप अलग-अलग रंग स्टॉप को संपादित करके**कस्टम रंग ग्रेडिएंट**बना सकते हैं।**एक कस्टम ग्रेडिएंट बनाने के लिए:**1. LUT पैनल में,**ग्रेडिएंट प्रीव्यू बार**का पता लगाएं
...
* **हेक्स कोड प्रविष्टि**: सटीक रंग विनिर्देश (उदाहरण के लिए,`#FF0000`लाल के लिए)
6.**नया रंग लगाने के लिए**रंग बीनने वाले को क्लिक करें**7. छवि पर ग्रेडिएंट**तुरंत अपडेट**होता है**रंग जोड़ना या हटाना बंद हो जाता है:**

* **एक स्टॉप जोड़ें**: अंत में एक नया नमूना जोड़ने के लिए + आइकन पर क्लिक करें
* **एक स्टॉप हटाएं**: नमूना हटाने के लिए रंग वर्ग पर डबल क्लिक करें**अनुकूलन रणनीतियाँ:**

* **इनवर्ट ग्रेडिएंट**: अर्थ को उलटने के लिए रंग क्रम को पलटें (उदाहरण के लिए, हरा = कम, लाल = अधिक)
...
{% hint style="info" %}**कस्टम ग्रेडिएंट्स को सहेजना**: कस्टम ग्रेडिएंट्स को सहेजा और पुन: उपयोग किया जा सकता है। भविष्य में उपयोग के लिए अपनी कस्टम रंग योजनाओं को संरक्षित करने के लिए LUT पैनल में सेव आइकन पर क्लिक करें।
{% endhint %}***## इंटरैक्टिव वर्कफ़्लो
...
* **रंग संपादित करें**→ कस्टम ग्रेडिएंट तुरंत लागू होता है**कोई "लागू करें" बटन की आवश्यकता नहीं**- सभी परिवर्तन लाइव और इंटरैक्टिव हैं!

{% hint style="success" %}**लाइव फीडबैक**: त्वरित विज़ुअल फीडबैक आपको विभिन्न सेटिंग्स के साथ तेजी से प्रयोग करने की अनुमति देता है जब तक कि आपको अपनी विश्लेषण आवश्यकताओं के लिए इष्टतम विज़ुअलाइज़ेशन नहीं मिल जाता।
{% endhint %}

### पुनरावृत्तीय शोधन कार्यप्रवाह**विशिष्ट LUT अनुकूलन वर्कफ़्लो:**1.**सूचकांक परत का चयन करें**(उदाहरण के लिए, रॉ (परावर्तन))
...
6.**क्लिपिंग चुनें**- संदर्भ के लिए "मूल पृष्ठभूमि" आज़माएँ
...
प्रभावी LUT रेंज सेट करने के लिए वास्तविक पिक्सेल मानों को समझना महत्वपूर्ण है:**मूल्यों का निरीक्षण कैसे करें:**1. पिक्सेल मान तब दिखाई देते हैं जब छवि में या तो इंडेक्स, या इंडेक्स और LUT दोनों**बॉक्स चेक**होते हैं।
2.**अपना कर्सर**छवि के विभिन्न क्षेत्रों पर ले जाएँ
3. जैसे ही आप होवर करते हैं लेजेंड में प्रदर्शित**पिक्सेल मानों का निरीक्षण करें**4. फ़्लोटिंग मान के साथ हाइलाइट किए गए अलग-अलग पिक्सेल देखने के लिए ज़ूम इन करें
...
* **पानी**(यदि मौजूद हो): उदाहरण के लिए, एनडीवीआई -0.05 से 0.10**LUT रेंज सेट करने के लिए पिक्सेल मानों का उपयोग करना:**पिक्सेल मानों का निरीक्षण करने के बाद, अपने LUT न्यूनतम/अधिकतम को तदनुसार समायोजित करें:**उदाहरण परिदृश्य:**
...
{% hint style="info" %}**गतिशील रेंज**: विभिन्न फसलों, मौसमों और विकास चरणों की अलग-अलग मूल्य श्रेणियां होंगी। LUT रेंज सेट करने से पहले हमेशा अपने विशिष्ट डेटासेट में पिक्सेल मानों का निरीक्षण करें।
{% endhint %}***## कस्टम सूचकांक (क्लोरोस+)

### कस्टम इंडेक्स फ़ॉर्मूले बनाना

{% hint style="info" %}**कहां बनाएं**: कस्टम इंडेक्स को प्रसंस्करण से पहले**प्रोजेक्ट सेटिंग्स**में कॉन्फ़िगर किया जा सकता है, साथ ही इमेज व्यूअर सैंडबॉक्स साइडबार में भी।
{% endhint %}**एक कस्टम इंडेक्स बनाने के लिए:**1.**प्रोजेक्ट सेटिंग्स खोलें**(प्रसंस्करण से पहले) या इमेज व्यूअर सैंडबॉक्स साइडबार
...
4.**बैंड वेरिएबल्स का उपयोग करके अपना फॉर्मूला परिभाषित करें**:
   ...
   * Operators: `+`, `-`, `*`, `/`, `^` (exponent)
* कार्य:`sqrt()`, `abs()`, आदि (यदि समर्थित हो)
...
{% hint style="warning" %}**फ़ॉर्मूला सत्यापन**: सुनिश्चित करें कि आपका फॉर्मूला आपके कैमरे में उपलब्ध बैंड का उपयोग करता है। उदाहरण के लिए, RedEdge केवल RedEdge फ़िल्टर वाले कैमरों पर उपलब्ध है।
{% endhint %}***
...
* [**एक छवि पूर्ण स्क्रीन खोलना**](एक छवि-पूर्ण स्क्रीन खोलना) - छवि दर्शक की मूल बातें
