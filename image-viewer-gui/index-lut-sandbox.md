...
इंडेक्स/LUT सैंडबॉक्स Chloros इमेज व्यूअर के भीतर एक इंटरैक्टिव कार्यक्षेत्र है जो आपको वास्तविक समय में मल्टीस्पेक्ट्रल इंडेक्स गणना और रंग विज़ुअलाइज़ेशन के साथ प्रयोग करने की अनुमति देता है। यह शक्तिशाली उपकरण आपको विभिन्न सूचकांकों का परीक्षण करने, मूल्य श्रेणियों को परिष्कृत करने और आपके संपूर्ण डेटासेट को पुन: संसाधित किए बिना प्रकाशन-तैयार विज़ुअलाइज़ेशन बनाने में मदद करता है।
...
Chloros में, प्रोजेक्ट प्रोसेसिंग के दौरान सूचकांक लागू किए जा सकते हैं। यह निर्धारित करने के लिए कि आप निर्यात पर कौन सी अनुक्रमणिका और LUT सेटिंग्स लागू करना चाहते हैं, छवि व्यूअर सैंडबॉक्स का उपयोग करना सबसे आसान है।

सैंडबॉक्स आपको इसकी अनुमति देता है:

* **डेटा को विज़ुअलाइज़ करने के लिए नए इंडेक्स और कलर ग्रेडिएंट्स (LUTs) लागू करें*** **विज़ुअलाइज़ेशन सेटिंग्स को अंतःक्रियात्मक रूप से समायोजित करें*** **देखें** पहले से ही गणना की गई सूचकांक छवियां
...
* **इनपुट**: सूचकांक पिक्सेल मान (उदाहरण के लिए, NDVI 0.65)
* **आउटपुट**: RGB रंग (जैसे, चमकीला हरा)
...
4. इंडेक्स बॉक्स को चेक करने पर छवि **तुरंत नए रंगों के साथ अपडेट हो जाती है**{% संकेत शैली = "सफलता" %}**सर्वोत्तम अभ्यास**: NDVI जैसे वनस्पति सूचकांकों के लिए, Red-Yellow-Green ग्रेडिएंट सबसे सहज है क्योंकि यह प्राकृतिक रंग संघों (हरा = स्वस्थ, पीला = मध्यम, लाल = तनावग्रस्त) के साथ संरेखित होता है।
{% अंतिम संकेत %}

### रंग वर्गों का समायोजन

**कक्षा नियंत्रण**यह निर्धारित करता है कि आपके ग्रेडिएंट में कितने अलग-अलग रंग चरण दिखाई देते हैं:**कक्षा गणना विकल्प:**
...
* **20+ कक्षाएं**: लगभग-निरंतर, अधिकतम चिकनाई**कैसे समायोजित करें:**
...
4. छवि पर ग्रेडिएंट **वास्तविक समय में** अपडेट होता है**विज़ुअलाइज़ेशन पर प्रभाव:*** **कम कक्षाएं** (3-5): अलग-अलग क्षेत्र बनाता है, वर्गीकरण को सरल बनाता है, श्रेणियों को अलग करना आसान होता है
* **मध्यम कक्षाएं** (6-10): संतुलित दृष्टिकोण, अधिकांश अनुप्रयोगों के लिए अच्छा
* **अधिक कक्षाएं** (15-20): सहज बदलाव, विस्तृत विविधता, फोटोग्राफिक उपस्थिति**कब उपयोग करें:*** **कुछ कक्षाएं (3-5)**: प्रस्तुति स्लाइड, वर्गीकरण मानचित्र, सरल रिपोर्ट
...
**मान श्रेणी नियंत्रण**यह निर्धारित करते हैं कि कौन सा सूचकांक मान आपके ग्रेडिएंट में किन रंगों से मेल खाता है:**LUT पैनल में रेंज नियंत्रण:*** **न्यूनतम मान**: रंग पैमाने की निचली सीमा
...
6. विज़ुअलाइज़ेशन **तुरंत अपडेट होता है**{% संकेत शैली = "जानकारी" %}**ऑटो-स्केलिंग**: जब आप पहली बार LUT लागू करते हैं, तो Chloros स्वचालित रूप से छवि में वास्तविक डेटा रेंज पर न्यूनतम/अधिकतम सेट करता है। फिर आप रुचि की विशिष्ट मूल्य श्रेणियों पर ध्यान केंद्रित करने के लिए इस सीमा को सीमित कर सकते हैं।
{% अंतिम संकेत %}

**उदाहरण NDVI रेंज समायोजन:*** **पूर्ण श्रेणी**: `-1.0` से `1.0` (सभी संभावित मान दिखाएं)
* **वनस्पति-केंद्रित**: `0.2` से `0.9` (नंगी मिट्टी और पानी को छोड़कर)
* **केवल स्वस्थ वनस्पति**: `0.5` से `0.9` (केवल जोरदार पौधों को हाइलाइट करें)
* **तनाव का पता लगाना**: `0.2` से `0.5` (समस्या क्षेत्रों पर जोर दें)
* **कस्टम रेंज**: अपने देखे गए पिक्सेल मानों के आधार पर समायोजित करें**श्रेणियाँ समायोजित क्यों करें?*** **अपनी रुचि के क्षेत्र में कंट्रास्ट बढ़ाएँ*** **अप्रासंगिक मूल्यों को हटा दें** (उदाहरण के लिए, जल निकाय, नंगी मिट्टी)
* **कई छवियों या तिथियों में विज़ुअलाइज़ेशन को मानकीकृत करें*** **एक संकीर्ण मूल्य सीमा के भीतर सूक्ष्म अंतरों पर जोर दें**
...
* **उदाहरण**: NDVI मान 0.2 से नीचे सभी लाल दिखाई देते हैं, 0.9 से ऊपर सभी मान हरे दिखाई देते हैं
...
{% संकेत शैली = "चेतावनी" %}
**पारदर्शिता सीमा**: पारदर्शी पिक्सेल व्यूअर में पृष्ठभूमि रंग के रूप में दिखाई देंगे। जब प्रसंस्करण के दौरान निर्यात किया जाता है, तो पारदर्शिता PNG प्रारूप में संरक्षित होती है लेकिन JPG में नहीं।
{% अंतिम संकेत %}
...
* **उदाहरण**: स्वस्थ क्षेत्रों को भूरे रंग में दिखाते हुए रंग-हाइलाइट तनावग्रस्त वनस्पति (NDVI 0.3-0.5)
...
अपने विज़ुअलाइज़ेशन पर पूर्ण नियंत्रण के लिए, आप अलग-अलग रंग स्टॉप को संपादित करके **कस्टम रंग ग्रेडिएंट** बना सकते हैं।**कस्टम ग्रेडिएंट बनाने के लिए:**
...
5. इसका उपयोग करके नया रंग चुनें:
   ...
   * **RGB/HSV स्लाइडर**: सटीक रंग नियंत्रण
...
7. छवि पर ग्रेडिएंट**तुरंत अपडेट** होता है**रंग जोड़ना या हटाना बंद हो जाता है:*** **स्टॉप जोड़ें**: अंत में एक नया नमूना जोड़ने के लिए + आइकन पर क्लिक करें
* **एक स्टॉप हटाएं**: नमूना हटाने के लिए रंग वर्ग पर डबल क्लिक करें**अनुकूलन रणनीतियाँ:*** **उलटा ग्रेडिएंट**: अर्थ को उलटने के लिए रंग क्रम को पलटें (उदाहरण के लिए, हरा = कम, लाल = अधिक)
...
3. **LUT ग्रेडिएंट लागू करें** - Red-Yellow-Green प्रीसेट से प्रारंभ करें
...
प्रभावी LUT रेंज सेट करने के लिए वास्तविक पिक्सेल मानों को समझना महत्वपूर्ण है:**मूल्यों का निरीक्षण कैसे करें:**
...
5. विभिन्न विशेषताओं के लिए मूल्य श्रेणियों के **नोट लें**:
   * **स्वस्थ वनस्पति**: उदाहरण के लिए, NDVI 0.55-0.85
   * **तनावग्रस्त वनस्पति**: उदाहरण के लिए, NDVI 0.30-0.50
   * **नंगी मिट्टी**: उदाहरण के लिए, NDVI 0.05-0.25
   * **पानी** (यदि मौजूद हो): उदाहरण के लिए, NDVI -0.05 से 0.10**LUT रेंज सेट करने के लिए पिक्सेल मानों का उपयोग करना:**पिक्सेल मानों का निरीक्षण करने के बाद, अपने LUT न्यूनतम/अधिकतम को तदनुसार समायोजित करें:**उदाहरण परिदृश्य:*** **अवलोकन**: मिट्टी का मान = 0.05-0.25, तनावग्रस्त = 0.25-0.50, स्वस्थ = 0.50-0.85
...
3. **"कस्टम"** विकल्प देखें (Chloros+ लाइसेंस के साथ लॉग इन होना चाहिए)
4. **बैंड वेरिएबल्स का उपयोग करके अपना फॉर्मूला परिभाषित करें**:
   * बैंड के नाम: `NIR`, `Red`, `Green`, `Blue`, `RedEdge`, आदि।
   * ऑपरेटर: `+`, `-`, `*`, `/`, `^` (प्रतिपादक)
...
* **अधिक जानें**: पढ़ें [मल्टीस्पेक्ट्रल इंडेक्स फॉर्मूला](../project-settings/multispectral-index-formulas.md)

संबंधित दस्तावेज़:

* [**छवि परतें**](image-layers.md) - परत प्रबंधन और विज़ुअलाइज़ेशन
* [**एक छवि को पूर्ण स्क्रीन पर खोलना**](opening-an-image-full-screen.md) - छवि दर्शक की मूल बातें
