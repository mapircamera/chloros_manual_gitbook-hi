...
4. इंडेक्स बॉक्स को चेक करने पर छवि **तुरंत नए रंगों के साथ अपडेट हो जाती है**{% hint style="success" %}**सर्वोत्तम अभ्यास**: NDVI जैसे वनस्पति सूचकांकों के लिए, Red-Yellow-Green ग्रेडिएंट सबसे सहज है क्योंकि यह प्राकृतिक रंग संघों (हरा = स्वस्थ, पीला = मध्यम, लाल = तनावग्रस्त) के साथ संरेखित होता है।
{% endhint %}
...
6. विज़ुअलाइज़ेशन **तुरंत अपडेट होता है**{% hint style="info" %}**ऑटो-स्केलिंग**: जब आप पहली बार LUT लागू करते हैं, तो Chloros स्वचालित रूप से छवि में वास्तविक डेटा रेंज पर न्यूनतम/अधिकतम सेट करता है। फिर आप रुचि की विशिष्ट मूल्य श्रेणियों पर ध्यान केंद्रित करने के लिए इस सीमा को सीमित कर सकते हैं।
{% endhint %}
