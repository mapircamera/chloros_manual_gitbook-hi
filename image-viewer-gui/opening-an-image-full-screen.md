...
Chloros इमेज व्यूअर आपकी मल्टीस्पेक्ट्रल छवियों को देखने, विश्लेषण करने और हेरफेर करने के लिए एक समर्पित फ़ुल-स्क्रीन इंटरफ़ेस प्रदान करता है। चाहे मूल छवियाँ देखना हो या संसाधित आउटपुट, इमेज व्यूअर निरीक्षण और विश्लेषण के लिए शक्तिशाली उपकरण प्रदान करता है।
...
4. पैनिंग रोकने के लिए रिलीज़ करें**वैकल्पिक**: छोटे-छोटे चरणों में पैन करने के लिए तीर कुंजियों का उपयोग करें***
...
* **जब और अधिक ज़ूम किया जाता है, तो कर्सर और हाइलाइट किए गए पिक्सेल के पास फ्लोटिंग मान*** पिक्सेल के लिए मान दिखाता है **कर्सर के नीचे या हाइलाइट किया गया*** जैसे ही आप माउस घुमाते हैं अपडेट हो जाता है
...
* JPG डेटा को पूर्वावलोकन के अनुसार प्रदर्शित करें
...
* परावर्तन अंशांकित
* मल्टी-बैंड TIFF (Red, Green, NIR, आदि)
...
2. वनस्पति सूचकांक चुनें (NDVI, NDRE, आदि)
3. मल्टीस्पेक्ट्रल फॉर्मूला चुनें, या अपना स्वयं का कस्टम फॉर्मूला बनाएं (केवल Chloros+)
4. विज़ुअलाइज़ेशन के लिए रंग LUT ग्रेडिएंट लागू करें
5. मूल्य सीमाएँ और सीमाएँ समायोजित करें

विस्तृत निर्देशों के लिए [इंडेक्स/LUT सैंडबॉक्स](index-lut-sandbox.md) देखें।
...
1. NDVI या अन्य अनुक्रमणिका छवि खोलें
2. वनस्पति क्षेत्रों की जाँच करें:
   * **NDVI**: स्वस्थ पौधों के लिए 0.4-0.9 दिखाना चाहिए
   * **NDRE**: जोरदार विकास के लिए उच्च मूल्य
   * **GNDVI**: NDVI के समान लेकिन क्लोरोफिल-संवेदनशील
...
* [**प्रसंस्करण छवियां (जीयूआई)**](../processing-images-gui/adding-files-to-a-project.md) - पूर्ण प्रसंस्करण गाइड