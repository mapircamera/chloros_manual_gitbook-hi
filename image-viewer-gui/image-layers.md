...
Chloros इमेज व्यूअर में इमेज लेयर्स ड्रॉपडाउन आपको एक ही छवि के विभिन्न संस्करणों के बीच जल्दी से स्विच करने की अनुमति देता है - मूल कैप्चर से संसाधित परावर्तन आउटपुट और गणना सूचकांक छवियों तक।

## छवि परतें क्या हैं?

Chloros में, **परतें** एकल स्रोत छवि के लिए उपलब्ध विभिन्न छवि आउटपुट को संदर्भित करती हैं। जब आप छवियों को संसाधित करते हैं, तो Chloros कई संस्करण बनाता है:
...
* **सूचकांक छवियां** (NDVI, NDRE, GNDVI, आदि यदि सूचकांक कॉन्फ़िगर किए गए थे)

छवि व्यूअर के ऊपरी दाएँ भाग में **लेयर सेलेक्टर ड्रॉपडाउन** आपको व्यूअर को छोड़े बिना इन संस्करणों के बीच तुरंत स्विच करने देता है।***
...
* सभी कैमरा चैनलों के साथ मल्टी-बैंड TIFF
* पिक्सेल मान प्रतिशत परावर्तन का प्रतिनिधित्व करते हैं (प्रतिशत मोड का उपयोग करते समय)
* [इंडेक्स/LUT सैंडबॉक्स](index-lut-sandbox.md) के साथ हेरफेर करने के लिए तैयार
...
### रॉ (NDVI इंडेक्स)... और समान

* परिकलित वनस्पति सूचकांक छवि (इस उदाहरण में NDVI)
...
* अगली छवि पर नेविगेट करते समय, Chloros उसी परत प्रकार को दिखाने का प्रयास करता है
...
**हमेशा उपलब्ध:*** ✅ JPG (प्रत्येक छवि में JPG पूर्वावलोकन होता है)
...
1. छवि 1 खोलें, RAW पर स्विच करें (NDVI इंडेक्स)
...
5. NDVI पैटर्न की जाँच करते हुए सभी छवियों को जारी रखें
...
5. सत्यापित करें कि पिक्सेल मान अपेक्षित सीमा में हैं (NIR के लिए 30-70%, Red के लिए 5-15%)
...
* **रेंज**: 0-65,535 (16-बिट TIFF) या 0.0-1.0 (32-बिट प्रतिशत)
* **अर्थ**: कैलिब्रेटेड प्रतिशत परावर्तन
* **उपयोग**: वैज्ञानिक माप और विश्लेषण**16-बिट TIFF के लिए:**प्रतिशत परावर्तन प्राप्त करने के लिए 65,535 से विभाजित करें**32-बिट प्रतिशत के लिए:** मान सीधे प्रतिशत का प्रतिनिधित्व करते हैं (0.5 = 50% परावर्तन)
...
* **उदाहरण**:
  * NDVI: -1 से +1 (वनस्पति आमतौर पर 0.4 से 0.9)
  * NDRE: -1 से +1 (तनाव का पता लगाना)
  * EVI: 0 से 1 (उन्नत वनस्पति)
...
* **सुसंगत वर्कफ़्लो**: एक परत चुनें (उदाहरण के लिए, NDVI) और दूसरे पर स्विच करने से पहले संपूर्ण डेटासेट की समीक्षा करें
...
**समस्या**: छवि अप्रत्याशित परत में खुलती है**कारण**: पिछली छवि से परत वरीयता को आगे बढ़ाया गया, लेकिन वह परत वर्तमान छवि पर मौजूद नहीं है**समाधान**: पसंदीदा परत अनुपलब्ध होने पर Chloros स्वचालित रूप से JPG पर वापस आ जाता है - यह सामान्य व्यवहार है

### अंशांकन लक्ष्य नहीं देख सकते

**समस्या**: RAW (लक्ष्य) परत लक्ष्य का पता लगाना नहीं दिखाती है**संभावित कारण:**
...
संपूर्ण इमेज व्यूअर दस्तावेज़ीकरण के लिए [एक छवि को पूर्ण स्क्रीन खोलना](opening-an-image-full-screen.md) देखें।
...
विवरण के लिए [इंडेक्स/LUT सैंडबॉक्स](index-lut-sandbox.md) देखें।
...
* [**एक छवि को पूर्ण स्क्रीन पर खोलना**](opening-an-image-full-screen.md) - संपूर्ण छवि दर्शक मार्गदर्शिका
* [**इंडेक्स/LUT सैंडबॉक्स**](index-lut-sandbox.md) - इंटरएक्टिव इंडेक्स विज़ुअलाइज़ेशन
* [**मल्टीस्पेक्ट्रल इंडेक्स फॉर्मूला**](../project-settings/multispectral-index-formulas.md) - उपलब्ध सूचकांक संदर्भ
