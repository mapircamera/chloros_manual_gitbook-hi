...
एक बार जब आप Chloros में एक प्रोजेक्ट बना या खोल लेते हैं, तो अगला कदम प्रोसेसिंग शुरू करने के लिए अपनी मल्टीस्पेक्ट्रल छवियों को जोड़ना होता है। फ़ाइल ब्राउज़र<img src='../.gitbook/assets/icon_file-browser.JPG' alt="" data-size="line"> टैब छवियों को आयात करना और आपके डेटासेट को प्रबंधित करना आसान बनाता है।
...
{% hint style="info" %}
**समर्थित फ़ाइल प्रकार**: Chloros, MAPIR Survey3W और Survey3N कैमरों से RAW+JPG और JPG छवि फ़ाइलों का समर्थन करता है। केवल RAW+JPG की अनुशंसा की जाती है।
{% endhint %}
...
1. फ़ाइल ब्राउज़र पैनल के शीर्ष पर **"फ़ाइलें जोड़ें"** <img src="../.gitbook/assets/image.png" alt="" data-size="line"> बटन पर क्लिक करें
...
1. फ़ाइल ब्राउज़र पैनल के शीर्ष पर **"फ़ोल्डर जोड़ें"** <img src="../.gitbook/assets/image (1).png" alt="" data-size="line"> बटन पर क्लिक करें।
...
* उदाहरण: Survey3W\_RGN, Survey3N\_OCN, Survey3W\_RGB
...
तालिका के ऊपर ऊपरी दाएं कोने में टॉगल बटन पर क्लिक करने से छवि ग्रिड क्षेत्र में चयनित छवि का मेटाडेटा दिखाई देता है।
...
2. **"चयनित हटाएं"** <img src="../.gitbook/assets/image (2).png" alt="" data-size="line"> बटन पर क्लिक करें
...
{% hint style="warning" %}
**महत्वपूर्ण**: आयात करने से पहले अपनी मूल छवि फ़ाइलों का नाम न बदलें या उन्हें संशोधित न करें। Chloros उचित प्रसंस्करण के लिए मूल फ़ाइल नाम और मेटाडेटा पर निर्भर करता है।
{% endhint %}
...
**उदाहरण परिदृश्य**: Survey3W RGN + Survey3N OCN डुअल-कैमरा सेटअप***
...
* छवियाँ गैर-MAPIR कैमरों से हैं (देखें [समर्थित कैमरे](../supported-cameras.md))
...
3. **लक्ष्य छवियों को चिह्नित करें** - देखें [लक्ष्य छवियां चुनना](choosing-target-images.md)
4. **सेटिंग्स समायोजित करें** - [प्रोजेक्ट सेटिंग्स](adjusting-project-settings.md) में प्रोसेसिंग विकल्प कॉन्फ़िगर करें
