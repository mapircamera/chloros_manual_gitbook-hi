...
एक बार प्रसंस्करण शुरू हो जाने के बाद, Chloros प्रगति की निगरानी करने, समस्याओं की जांच करने और यह समझने के लिए कई तरीके प्रदान करता है कि आपके डेटासेट के साथ क्या हो रहा है। यह पृष्ठ बताता है कि अपनी प्रोसेसिंग को कैसे ट्रैक करें और Chloros द्वारा प्रदान की गई जानकारी की व्याख्या कैसे करें।
...
Chloros+ लाइसेंस के बिना उपयोगकर्ताओं के लिए:
...
Chloros+ लाइसेंस वाले उपयोगकर्ताओं के लिए:
...
4. **निर्यात** - संसाधित फ़ाइलों को सहेजना**इंटरैक्टिव विशेषताएं:**

* *विस्तारित 4-स्टेज पैनल देखने के लिए प्रगति बार पर होवर करें
* **विस्तारित पैनल को फ़्रीज़/पिन करने के लिए प्रगति पट्टी पर क्लिक करें*** **माउस लीव पर अनफ़्रीज़ और ऑटो-छिपाने के लिए फिर से क्लिक करें*** प्रत्येक चरण व्यक्तिगत प्रगति दर्शाता है (0-100%)
...
{% hint style="info" %}
**पाइपलाइन आर्किटेक्चर**: ये 4 जीयूआई चरण [4-थ्रेड प्रोसेसिंग पाइपलाइन](../processing-architecture/processing-pipeline.md) के अनुरूप हैं। GPU त्वरण वाले सिस्टम पर, थ्रेड 3 (कैलिब्रेटिंग) को [डायनामिक कंप्यूट अनुकूलन](../processing-architecture/dynamic-compute-adaptation.md) से लाभ मिलता है जो आपके विशिष्ट हार्डवेयर के लिए प्रसंस्करण को अनुकूलित करता है।
{% endhint %}
...
* Chloros लक्ष्य चेकबॉक्स से चिह्नित छवियों को स्कैन करता है
...
* समानांतर प्रसंस्करण श्रमिकों को तैयार करना (केवल Chloros+)

**अवधि:** 5-30 सेकंड**प्रगति सूचक:**
...
**क्या हो रहा है:*** **डिबेयरिंग**: रॉ बायर पैटर्न को 3 चैनलों में परिवर्तित करना
...
**अवधि:** कुल प्रसंस्करण समय का अधिकांश भाग (60-80%)**प्रगति सूचक:**
...
* **Chloros+ मोड**: एक साथ 16 छवियों को संसाधित करता है
* **जीपीयू त्वरण**: इस चरण में उल्लेखनीय रूप से गति बढ़ाता है**क्या देखना है:**
...
**अवधि:** कुल प्रसंस्करण समय का 10-20%**प्रगति सूचक:**
...
4. जरूरत पड़ने पर MAPIR सपोर्ट पर भेजें
...
* Windows टास्क मैनेजर (Ctrl+Shift+Esc)
* प्रदर्शन टैब → सीपीयू अनुभाग
* "Chloros" या "क्लोरोस-बैकएंड" प्रक्रियाओं को देखें
...
* Chloros+ समानांतर मोड अधिक RAM का उपयोग करता है
...
* यह सुनिश्चित करने के लिए कार्य प्रबंधक की जाँच करें कि Chloros चल रहा है
...
* Chloros+ समानांतर मोड बहुत अधिक संसाधनों का उपयोग कर रहा है
...
3. बड़े डेटासेट के बैच प्रोसेसिंग के लिए CLI पर विचार करें
...
3. प्रोसेसिंग लोड कम करें (Chloros+ के बजाय फ्री मोड का उपयोग करें)
