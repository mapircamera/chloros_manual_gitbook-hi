...
{% hint style="info" %}**सेटिंग्स आपके प्रोजेक्ट के साथ स्वचालित रूप से सहेजी जाती हैं**। जब आप किसी प्रोजेक्ट को दोबारा खोलते हैं, तो सभी सेटिंग्स पुनर्स्थापित हो जाती हैं।
{% endhint %}***
...
बस अपनी छवियां आयात करें और इन डिफ़ॉल्ट के साथ प्रसंस्करण शुरू करें।***## प्रोजेक्ट सेटिंग्स अवलोकन
...
नियंत्रित करता है कि क्लोरोस आपकी छवियों में अंशांकन लक्ष्यों की पहचान कैसे करता है।**मुख्य सेटिंग्स:**
...
* **न्यूनतम पुनर्अंशांकन अंतराल**: अंशांकन लक्ष्यों का उपयोग करने के बीच का समय (0 = सभी का उपयोग करें)**एडवांस सेटिंग:**
...
कॉन्फ़िगर करें कि किस वनस्पति सूचकांक की गणना और निर्यात करना है।**सूचकांक कैसे जोड़ें:**1.**"अनुक्रमणिका जोड़ें"**बटन पर क्लिक करें
...
4. आवश्यकतानुसार एकाधिक सूचकांक जोड़ें**लोकप्रिय सूचकांक:**
...
* **ईवीआई**: उच्च पत्ती क्षेत्र सूचकांक (एलएआई) क्षेत्र**कस्टम सूत्र (केवल क्लोरोस+):**
...
* **जेपीजी (8-बिट)**: सबसे छोटी फ़ाइलें, हानिपूर्ण संपीड़न (0-255 रेंज)***## सेटिंग्स सहेजना और लोड करना
...
4. सेव आइकन पर क्लिक करें**फ़ायदे:**
...
### कार्यकारी डाइरेक्टरी**"प्रोजेक्ट फ़ोल्डर सहेजें"** सेटिंग निर्दिष्ट करती है कि डिफ़ॉल्ट रूप से नए प्रोजेक्ट कहां बनाए जाते हैं:
...
4. कैमरे को एक्सपोज़र पिन पर असाइन करें:
   ...
   * **दोहरे कैमरे**: प्रत्येक कैमरे को पिन सही करने के लिए मैन्युअल रूप से असाइन करें**एक्सपोज़र पिन असाइनमेंट:**
...
4. सभी कैमरे समान निर्यात प्रारूप और सूचकांक का उपयोग करते हैं**उदाहरण**: सर्वे3डब्ल्यू आरजीएन + सर्वे3एन ओसीएन डुअल-कैमरा रिग
