...
विशिष्ट MAPIR Survey3 कैमरा वर्कफ़्लो के लिए, डिफ़ॉल्ट सेटिंग्स अच्छी तरह से काम करती हैं:

* ✅ **विग्नेट सुधार**: सक्षम
* ✅ **परावर्तन अंशांकन**: सक्षम (MAPIR लक्ष्यों की छवियों की आवश्यकता है)
* ✅ **डिबायर विधि**: मानक (तेज, मध्यम गुणवत्ता)
* ✅ **निर्यात प्रारूप**: TIFF (16-बिट)
...
यह नियंत्रित करता है कि Chloros आपकी छवियों में अंशांकन लक्ष्यों की पहचान कैसे करता है।

**मुख्य सेटिंग्स:*** **न्यूनतम अंशांकन नमूना क्षेत्र**: लक्ष्य का पता लगाने के लिए आकार सीमा (डिफ़ॉल्ट: 25 पिक्सेल)
* **न्यूनतम लक्ष्य क्लस्टरिंग**: लक्ष्य क्षेत्रों को समूहीकृत करने के लिए समानता सीमा (डिफ़ॉल्ट: 60)**कब समायोजित करें:**
...
**मुख्य सेटिंग्स:*** **विग्नेट सुधार**: किनारों पर लेंस के कालेपन की भरपाई करता है ✅ अनुशंसित
...
* **न्यूनतम पुनर्अंशांकन अंतराल**: अंशांकन लक्ष्यों का उपयोग करने के बीच का समय (0 = सभी का उपयोग करें)**एडवांस सेटिंग:*** **लाइट सेंसर टाइमज़ोन ऑफ़सेट**: पीपीके समय सिंक्रनाइज़ेशन के लिए (डिफ़ॉल्ट: 0)
...
वर्तमान में हम Chloros में 2 डिबेयरिंग विधियाँ प्रदान करते हैं:

#### मानक (तेज़, मध्यम गुणवत्ता)

मानक डिबेयर तेजी से प्रक्रिया करता है लेकिन डिबेयरिंग रंग शोर दिखाता है, जिसके परिणामस्वरूप कम सटीक और अधिक शोर वाली छवियां होती हैं।

#### टेक्सचर अवेयर (धीमी, उच्चतम गुणवत्ता) \[Chloros+ केवल]

टेक्सचर अवेयर एआई/एमएल डीनोइज़िंग मॉडल के साथ संयुक्त उच्च गुणवत्ता वाले एज-अवेयर डिबेयर का उपयोग करता है जो लगभग सभी डिबेयरिंग शोर को हटा देता है। टेक्सचर अवेयर मॉडल को चलाने के लिए GPU मेमोरी (VRAM) की आवश्यकता होती है। जब आपके पास तेज़ प्रोसेसिंग के लिए >4GB VRAM उपलब्ध हो तो हम इसका उपयोग करने की सलाह देते हैं।
...
2. ड्रॉपडाउन मेनू से एक इंडेक्स चुनें (NDVI, NDRE, GNDVI, आदि)
3. विज़ुअलाइज़ेशन सेटिंग्स कॉन्फ़िगर करें (LUT रंग, मान श्रेणियां)
4. आवश्यकतानुसार एकाधिक सूचकांक जोड़ें

**लोकप्रिय सूचकांक:*** **NDVI**: सामान्य वनस्पति स्वास्थ्य (सबसे आम)
* **NDRE**: RedEdge के साथ प्रारंभिक तनाव का पता लगाना
* **GNDVI**: क्लोरोफिल सांद्रता संवेदनशील
* **OSAVI**: दृश्यमान मिट्टी के साथ अच्छा काम करता है
* **EVI**: उच्च पत्ती क्षेत्र सूचकांक (LAI) क्षेत्र**कस्टम सूत्र (केवल Chloros+):**
...
सभी उपलब्ध सूचकांकों और सूत्रों के लिए, [मल्टीस्पेक्ट्रल इंडेक्स फॉर्मूला](../project-settings/multispectral-index-formulas.md) देखें।

### निर्यात

आउटपुट फ़ाइल स्वरूप और गुणवत्ता को नियंत्रित करता है।

**उपलब्ध प्रारूप:*** **TIFF (16-बिट)**: जीआईएस और वैज्ञानिक विश्लेषण के लिए अनुशंसित (0-65,535 रेंज)
* **TIFF (32-बिट, प्रतिशत)**: फ़्लोटिंग-पॉइंट परावर्तन मान (0.0-1.0 रेंज)
* **PNG (8-बिट)**: विज़ुअलाइज़ेशन के लिए दोषरहित संपीड़न (0-255 रेंज)
...
4. कैमरे को एक्सपोज़र पिन पर असाइन करें:
   ...
   * **दोहरे कैमरे**: प्रत्येक कैमरे को पिन सही करने के लिए मैन्युअल रूप से असाइन करें**एक्सपोज़र पिन असाइनमेंट:*** **एक्सपोज़र पिन 1**: ड्रॉपडाउन से कैमरा मॉडल चुनें
...
1. Chloros स्वचालित रूप से प्रत्येक कैमरा मॉडल का पता लगाता है
...
**उदाहरण**: Survey3W RGN + Survey3N OCN डुअल-कैमरा रिग
...
* तेज़ परिणामों के लिए Chloros+ समानांतर प्रसंस्करण का उपयोग करें
* बैच स्वचालन के लिए CLI या API पर विचार करें
...
1. **अंशांकन लक्ष्य छवियों को चिह्नित करें** - देखें [लक्ष्य छवियां चुनना](choosing-target-images.md)
