...
एक बार जब आप अपनी छवियां आयात कर लेते हैं, अपने अंशांकन लक्ष्यों को चिह्नित कर लेते हैं, और अपनी प्रोजेक्ट सेटिंग्स कॉन्फ़िगर कर लेते हैं, तो आप प्रसंस्करण शुरू करने के लिए तैयार हैं। यह पृष्ठ Chloros प्रसंस्करण पाइपलाइन आरंभ करने में आपका मार्गदर्शन करता है।
...
* चिह्न: **प्ले/स्टार्ट बटन** <img src='../.gitbook/assets/image (2) (1).png'' alt="" data-size="line">
...
{% hint style="success" %}
**प्रसंस्करण प्रारंभ**: एक बार क्लिक करने पर, Chloros स्वचालित रूप से सभी प्रसंस्करण चरणों को संभालता है - लक्ष्य का पता लगाना, डिबेयरिंग, अंशांकन, सूचकांक गणना और निर्यात।
{% endhint %}
...
Chloros आपके लाइसेंस के आधार पर दो अलग-अलग प्रोसेसिंग मोड में काम करता है:
...
### Chloros+ मोड (समानांतर प्रसंस्करण)

**Chloros+ लाइसेंस की आवश्यकता है**

**यह काम किस प्रकार करता है:**

* [4-थ्रेड प्रोसेसिंग पाइपलाइन](../processing-architecture/processing-pipeline.md) का उपयोग करके एक साथ कई छवियों को संसाधित करता है
* [डायनामिक कंप्यूट अनुकूलन](../processing-architecture/dynamic-compute-adaptation.md) स्वचालित रूप से आपके हार्डवेयर के लिए इष्टतम रणनीति का चयन करता है
* NVIDIA ग्राफिक्स कार्ड (डेस्कटॉप और जेटसन) के साथ GPU (CUDA) त्वरण
* जेटसन नैनो (1 वर्कर) से 12GB+ GPU (3-4 वर्कर) वाले डेस्कटॉप तक स्केल

**प्रगति पट्टी 4 चरण दिखाती है** (4 पाइपलाइन थ्रेड के अनुरूप):

1. **पता लगाना** (थ्रेड 1) - अंशांकन लक्ष्य ढूँढना
2. **विश्लेषण** (थ्रेड 2) - छवि मेटाडेटा की जांच करना और अंशांकन की गणना करना
3. **कैलिब्रेटिंग** (थ्रेड 3) - जीपीयू डिबेयरिंग, विग्नेट सुधार, इंडेक्स गणना
4. **निर्यात** (थ्रेड 4) - संसाधित छवियों और सूचकांकों को सहेजना**प्रगति बार इंटरेक्शन:**
...
* **पैनल को अनफ़्रीज़ करने और छिपाने के लिए**फिर से क्लिक करें**प्रोसेसिंग समय:**
...
{% hint style="info" %}
**Chloros+ स्पीड**: बड़े डेटासेट के लिए समानांतर प्रसंस्करण अनुक्रमिक मोड की तुलना में 5-10 गुना तेज हो सकता है। एक 500-छवि प्रोजेक्ट जिसमें फ्री मोड में 2 घंटे लगते हैं, Chloros+ के साथ 15-20 मिनट में पूरा हो सकता है।
{% endhint %}
...
**Chloros क्या करता है:*** **विग्नेट सुधार**: किनारों पर लेंस का कालापन दूर करता है
...
* कॉन्फ़िगर किए गए मल्टीस्पेक्ट्रल सूचकांकों की गणना करता है (NDVI, NDRE, आदि)
...
* Chloros को न्यूनतम करना और अन्य अनुप्रयोगों में काम करना सुरक्षित है

**Chloros+ समानांतर मोड:**
...
{% hint style="warning" %}
**प्रदर्शन युक्ति**: सर्वोत्तम Chloros+ प्रदर्शन के लिए, अन्य एप्लिकेशन बंद करें और Chloros को पूर्ण सिस्टम संसाधनों का उपयोग करने दें।
{% endhint %}
...
**योजना युक्ति:** बहुत बड़ी परियोजनाओं के लिए, बेहतर नियंत्रण के लिए बैचों में प्रसंस्करण या CLI का उपयोग करने पर विचार करें।***
...
* सबसे साफ अनुभव के लिए, Chloros को पूरी तरह से बंद करें और पुनरारंभ करें

{% hint style="warning" %}
**कोई आंशिक परिणाम नहीं**: रद्द करने से सारी प्रगति खारिज हो जाती है। Chloros आंशिक रूप से संसाधित छवियों को सहेजता नहीं है।
{% endhint %}
...
* प्रोसेसिंग मोड (फ्री बनाम Chloros+)
* सीपीयू स्पीड और कोर गिनती
* GPU उपलब्धता (केवल Chloros+)
* गणना करने के लिए सूचकांकों की संख्या
* निर्यात प्रारूप जटिलता

### अनुमानित अनुमान (Chloros+, 12MP छवियाँ, आधुनिक CPU)

| छवि गणना | फ्री मोड | Chloros+ (सीपीयू) | Chloros+ (GPU) |
| ----------- | --------- | -------------- | -------------- |
...
{% hint style="info" %}
**पहला रन**: प्रारंभिक प्रसंस्करण में अधिक समय लग सकता है क्योंकि Chloros कैश और प्रोफाइल बनाता है। समान डेटासेट की बाद की प्रोसेसिंग तेज़ होगी।
{% endhint %}
...
3. यदि बटन अक्षम रहता है तो Chloros को पुनरारंभ करें
...
2. **Chloros को अग्रभूमि में रखें** - या कम से कम टास्कबार में दिखाई दे
3. **समय-समय पर प्रगति की निगरानी करें** - चेतावनियों या त्रुटियों की जाँच करें
4. **अन्य भारी एप्लिकेशन लोड न करें** - विशेष रूप से Chloros+ समानांतर मोड के साथ
