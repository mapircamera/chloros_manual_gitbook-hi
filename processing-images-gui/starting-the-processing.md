...
{% hint style="info" %}**टिप**: प्रसंस्करण से पहले यह सत्यापित करने के लिए कि वे सही ढंग से लोड हुई हैं, फ़ाइल ब्राउज़र में कुछ छवियों पर क्लिक करें।
{% endhint %}***
...
1. शीर्ष शीर्षलेख में **प्ले/स्टार्ट बटन**पर क्लिक करें
2. प्रसंस्करण तुरंत शुरू होता है
3. प्रसंस्करण के दौरान बटन अक्षम हो जाता है (धूसर हो जाता है)।
4. प्रगति बार अद्यतन, प्रसंस्करण स्थिति दिखा रहा है

{% hint style="success" %}**प्रसंस्करण प्रारंभ**: एक बार क्लिक करने पर, क्लोरोस स्वचालित रूप से सभी प्रसंस्करण चरणों को संभालता है - लक्ष्य का पता लगाना, डिबेयरिंग, अंशांकन, सूचकांक गणना और निर्यात।
{% endhint %}***## प्रोसेसिंग मोड को समझना

क्लोरोस आपके लाइसेंस के आधार पर दो अलग-अलग प्रसंस्करण मोड में काम करता है:

### फ्री मोड (अनुक्रमिक प्रसंस्करण)**सभी उपयोगकर्ताओं के लिए उपलब्ध**
**यह काम किस प्रकार करता है:**

* छवियों को एक-एक करके, क्रमिक रूप से संसाधित करता है
* सिंगल-थ्रेडेड ऑपरेशन
* कम मेमोरी उपयोग

**प्रगति पट्टी 2 चरण दिखाती है:**1.**लक्ष्य का पता लगाएं**- अंशांकन लक्ष्यों के लिए स्कैनिंग
2.**प्रसंस्करण**- अंशांकन लागू करना और छवियों को निर्यात करना**प्रोसेसिंग समय:**
...
* एकाधिक CPU कोर का उपयोग करता है
* NVIDIA ग्राफ़िक्स कार्ड के साथ वैकल्पिक GPU (CUDA) त्वरण

**प्रगति पट्टी 4 चरण दिखाती है:**1.**पता लगाना**- अंशांकन लक्ष्य ढूँढना
2.**विश्लेषण**- छवि मेटाडेटा की जांच करना और पाइपलाइन तैयार करना
3.**अंशांकन**- सुधार और अंशांकन लागू करना
4.**निर्यात**- संसाधित छवियों और सूचकांकों को सहेजना**प्रगति बार इंटरेक्शन:**

* विस्तृत 4-स्टेज ड्रॉपडाउन पैनल देखने के लिए **माउस** को बार पर घुमाएँ
...
* फ्री मोड की तुलना में काफी तेज़
...
{% endhint %}***## प्रसंस्करण के दौरान क्या होता है

### चरण 1: लक्ष्य का पता लगाना**क्लोरोस क्या करता है:**

* चिह्नित लक्ष्य छवियों को स्कैन करता है (या यदि कोई भी चिह्नित नहीं है तो सभी छवियां)
* प्रत्येक लक्ष्य में 4 अंशांकन पैनलों की पहचान करता है
* लक्ष्य पैनलों से परावर्तन मान निकालता है
* अंशांकन शेड्यूलिंग के लिए लक्ष्य टाइमस्टैम्प रिकॉर्ड करता है

**अवधि:**1-30 seconds (with marked targets), 5-30+ minutes (unmarked)

### स्टेज 2: डिबेयरिंग (रॉ रूपांतरण)**क्लोरोस क्या करता है:**

* RAW बायर पैटर्न डेटा को पूर्ण RGB छवियों में परिवर्तित करता है
* उच्च-गुणवत्ता वाला डेमोसैसिंग एल्गोरिदम लागू करता है
* अधिकतम छवि गुणवत्ता और विवरण सुरक्षित रखता है

**अवधि:**Varies by image count and CPU speed

### चरण 3: अंशांकन**क्लोरोस क्या करता है:**
...
**अवधि:**Majority of processing time

### चरण 4: सूचकांक गणना**क्लोरोस क्या करता है:**
...
**अवधि:**A few seconds per image

### चरण 5: निर्यात**क्लोरोस क्या करता है:**

* कैलिब्रेटेड छवियों को चयनित प्रारूप में सहेजता है
* कॉन्फ़िगर किए गए LUT रंगों के साथ अनुक्रमणिका छवियाँ निर्यात करता है
* कैमरा मॉडल सबफ़ोल्डर्स में फ़ाइलें लिखता है
* मूल फ़ाइल नामों को प्रत्ययों के साथ सुरक्षित रखता है

**अवधि:**Varies by export format and file size***
...
* प्रगति अद्यतन वास्तविक समय में दिखाए जाते हैं

### प्रोसेसिंग के दौरान कंप्यूटर का उपयोग

**मुक्त मोड:**

* अपेक्षाकृत कम CPU उपयोग (एकल-थ्रेडेड)
* कंप्यूटर अन्य कार्यों के लिए उत्तरदायी रहता है
* क्लोरोज़ को न्यूनतम करना और अन्य अनुप्रयोगों में काम करना सुरक्षित है

**क्लोरोस+समानांतर मोड:**

* उच्च CPU उपयोग (बहु-थ्रेडेड, 16 कोर तक)
* GPU त्वरण के साथ: उच्च GPU उपयोग
* प्रोसेसिंग के दौरान कंप्यूटर कम प्रतिक्रियाशील हो सकता है
* अन्य सीपीयू-गहन कार्य शुरू करने से बचें
...
### प्रसंस्करण रोका नहीं जा सकता**महत्वपूर्ण सीमाएँ:**

* एक बार शुरू होने के बाद प्रोसेसिंग को रोका नहीं जा सकता
* आप प्रसंस्करण रद्द कर सकते हैं, लेकिन प्रगति खो गई है
* आंशिक परिणाम सहेजे नहीं गए हैं
* रद्द होने पर प्रारंभ से पुनः आरंभ करना होगा

**योजना युक्ति:**For very large projects, consider processing in batches or using CLI for better control.***
...
निगरानी पर विस्तृत जानकारी के लिए, [प्रसंस्करण की निगरानी](monitoring-the-processing.md) देखें।***## प्रसंस्करण रद्द किया जा रहा है
...
* आरंभ से प्रसंस्करण पुनः प्रारंभ करें
* सबसे साफ़ अनुभव के लिए, क्लोरोस को पूरी तरह से बंद करें और पुनः आरंभ करें
...
| छवि गणना | मुक्त मोड | क्लोरोस+ (सीपीयू) | क्लोरोस+ (जीपीयू) |
| ----------- | --------- | -------------- | -------------- |
| 50 छवियाँ   | 15-20 मि | 5-8 मि        | 3-5 मिनट        |
| 100 छवियाँ  | 30-40 मि | 10-15 मि      | 5-8 मि        |
| 200 छवियाँ  | 1-1.5 बजे | 20-30 मि      | 10-15 मि      |
| 500 छवियाँ  | 2-3 घंटे   | 45-60 मि      | 20-30 मि      |
| 1000 छवियाँ | 4-6 घंटे   | 1.5-2 घंटे      | 40-60 मि      |
...
{% endhint %}***## प्रारंभ में सामान्य मुद्दे

### प्रारंभ बटन अक्षम (धूसर हो गया)**संभावित कारण:**

* कोई छवि आयात नहीं की गई
* बैकएंड पूरी तरह प्रारंभ नहीं हुआ
* पिछली प्रोसेसिंग अभी भी चल रही है
* प्रोजेक्ट पूरी तरह लोड नहीं हुआ

**समाधान:**1. बैकएंड के पूरी तरह आरंभ होने तक प्रतीक्षा करें (मुख्य मेनू आइकन जांचें)
2. सत्यापित करें कि छवियाँ फ़ाइल ब्राउज़र में आयात की गई हैं
3. यदि बटन अक्षम रहता है तो क्लोरोस को पुनः आरंभ करें
4. त्रुटि संदेशों के लिए डिबग लॉग की जाँच करें

### प्रोसेसिंग शुरू होती है और फिर तुरंत विफल हो जाती है**संभावित कारण:**
...
**समाधान:**1. डिबग लॉग की जाँच करें<img src="../.gitbook/assets/icon_log.JPG" alt="" data-size="line">त्रुटि संदेशों के लिए
...
### "कोई लक्ष्य नहीं मिला" चेतावनी**संभावित कारण:**

* लक्ष्य छवियों को चिह्नित करना भूल गए
* लक्ष्य छवियों में दृश्यमान लक्ष्य नहीं होते हैं
* लक्ष्य पहचान सेटिंग बहुत सख्त हैं

**समाधान:**1. समीक्षा करें [लक्ष्य छवियाँ चुनना](choosing-target-images.md)
2. लक्ष्य कॉलम में उपयुक्त छवियों को चिह्नित करें
3. सत्यापित करें कि लक्ष्य चिह्नित छवियों में दिखाई दे रहे हैं
4. यदि आवश्यक हो तो लक्ष्य पहचान सेटिंग्स समायोजित करें***## सफल प्रसंस्करण के लिए युक्तियाँ
...
3. GPU-सघन एप्लिकेशन बंद करें (गेम, वीडियो संपादन)
4. GPU तापमान की निगरानी करें (पर्याप्त शीतलन सुनिश्चित करें)***## अगले कदम
