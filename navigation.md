...
मुख्य मेनू से आप यह कर सकते हैं:

* **नया प्रोजेक्ट** — एक नया प्रोजेक्ट बनाएं
* **प्रोजेक्ट खोलें** - एक मौजूदा प्रोजेक्ट खोलें
* **प्रोजेक्ट फ़ोल्डर खोलें** - अपने फ़ाइल एक्सप्लोरर में प्रोजेक्ट फ़ोल्डर खोलें
* **फ़ाइलें जोड़ें** - वर्तमान प्रोजेक्ट में अलग-अलग छवि फ़ाइलें जोड़ें _(प्रोजेक्ट खुलने के बाद दिखाई देती है)_
* **फ़ोल्डर जोड़ें** - वर्तमान प्रोजेक्ट में छवियों का एक फ़ोल्डर जोड़ें _(प्रोजेक्ट खुलने के बाद दिखाई देता है)_
* **प्रोसेसिंग शुरू करें / प्रोसेसिंग रोकें** - इमेज प्रोसेसिंग पाइपलाइन शुरू या बंद करें _(फ़ाइलें जोड़ने के बाद सक्षम)_

{% hint style="info" %}
**केवल Windows**: Chloros डेस्कटॉप GUI Windows पर उपलब्ध है। Linux उपयोगकर्ताओं को हेडलेस प्रोसेसिंग के लिए [CLI](CLI.md) और [Python SDK](api-python-sdk.md) दस्तावेज़ देखना चाहिए।
{% endhint %}
...
#### <img src='.gitbook/assets/icon_project-settings.JPG'
...
#### <img src='.gitbook/assets/icon_image-viewer.JPG'
...
#### <img src='.gitbook/assets/icon_user.JPG'
