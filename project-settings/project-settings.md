...
Chloros में प्रोजेक्ट सेटिंग्स <img src='../.gitbook/assets/icon_project-settings.JPG' ये सेटिंग्स आपके प्रोजेक्ट के साथ सहेजी जाती हैं और कई परियोजनाओं में पुन: उपयोग के लिए टेम्पलेट के रूप में सहेजी जा सकती हैं।

## प्रोजेक्ट सेटिंग्स तक पहुँचना

प्रोजेक्ट सेटिंग्स तक पहुँचने के लिए:

1. Chloros में एक प्रोजेक्ट खोलें
...
ये सेटिंग्स नियंत्रित करती हैं कि Chloros आपकी छवियों में अंशांकन लक्ष्यों का कैसे पता लगाता है और उन्हें संसाधित करता है।
...
ये सेटिंग्स नियंत्रित करती हैं कि Chloros आपकी छवियों को कैसे संसाधित और कैलिब्रेट करता है।
...
* **विकल्प**:
  * मानक (तेज, मध्यम गुणवत्ता)
  * बनावट जागरूक (धीमी, उच्चतम गुणवत्ता) \[Chloros+]
* **डिफ़ॉल्ट**: मानक (तेज़, मध्यम गुणवत्ता)
* **विवरण**: कच्चे बायर पैटर्न सेंसर डेटा को पूर्ण-रंगीन छवियों में परिवर्तित करने के लिए उपयोग किए जाने वाले डेमोसेसिंग एल्गोरिदम का चयन करता है। "मानक (तेज़, मध्यम गुणवत्ता)" विधि प्रसंस्करण गति और छवि गुणवत्ता के बीच एक इष्टतम संतुलन प्रदान करती है। "टेक्सचर अवेयर (धीमी, उच्चतम गुणवत्ता)" \[Chloros+] एक एआई/एमएल डीनोइज़िंग मॉडल के साथ संयुक्त उच्च-गुणवत्ता वाले एज-अवेयर डिबेयर का उपयोग करता है जो लगभग सभी डिबेयरिंग शोर को हटा देता है। टेक्सचर अवेयर मॉडल को चलाने के लिए GPU मेमोरी (VRAM) की आवश्यकता होती है। जब आपके पास तेज़ प्रोसेसिंग के लिए >4GB VRAM उपलब्ध हो तो हम इसका उपयोग करने की सलाह देते हैं।
* **नोट**: Chloros के भविष्य के संस्करणों में अतिरिक्त डिबायर विधियां जोड़ी जा सकती हैं।
...
* **डिफ़ॉल्ट**: 0 सेकंड
* **विवरण**: अंशांकन लक्ष्यों का उपयोग करने के बीच न्यूनतम समय अंतराल (सेकंड में) निर्धारित करता है। 0 पर सेट होने पर, Chloros प्रत्येक ज्ञात अंशांकन लक्ष्य का उपयोग करेगा। उच्च मान पर सेट होने पर, Chloros केवल उन अंशांकन लक्ष्यों का उपयोग करेगा जो कम से कम इतने सेकंड से अलग होते हैं, जिससे बार-बार अंशांकन लक्ष्य कैप्चर वाले डेटासेट के लिए प्रसंस्करण समय कम हो जाता है।
* **कब समायोजित करें**:
...
* **विवरण**: जीपीएस (जीएनएसएस) युक्त MAPIR DAQ रिकॉर्डर से पोस्ट-प्रोसेस्ड किनेमेटिक (PPK) सुधार के उपयोग को सक्षम करता है। सक्षम होने पर, Chloros आपके प्रोजेक्ट निर्देशिका में एक्सपोज़र पिन डेटा वाली किसी भी .daq लॉग फ़ाइल का उपयोग करेगा और आपकी छवियों पर सटीक जियोलोकेशन सुधार लागू करेगा।
...
* **विवरण**: एक इंटरैक्टिव पैनल खोलता है जहां आप छवि प्रसंस्करण के दौरान गणना करने के लिए मल्टीस्पेक्ट्रल वनस्पति सूचकांक (NDVI, NDRE, EVI, आदि) का चयन और कॉन्फ़िगर कर सकते हैं। आप अनेक सूचकांक जोड़ सकते हैं, प्रत्येक की अपनी विज़ुअलाइज़ेशन सेटिंग्स होंगी।
* **उपलब्ध सूचकांक**: सिस्टम में 30+ पूर्व-परिभाषित मल्टीस्पेक्ट्रल सूचकांक शामिल हैं:
  ...
  * और भी बहुत कुछ (पूरी सूची के लिए [मल्टीस्पेक्ट्रल इंडेक्स फॉर्मूला](multispectral-index-formulas.md) देखें)
**विशेषताएं**:
...
* **कैसे बनाएं**:
  ...
  2. बैंड पहचानकर्ताओं (जैसे, NIR, Red, Green, Blue) का उपयोग करके अपने सूत्र को परिभाषित करें
...
* **सूत्र वाक्यविन्यास**: मानक गणितीय संचालन समर्थित हैं, जिनमें शामिल हैं:
  ...
  * बैंड संदर्भ: NIR, Red, Green, Blue, RedEdge, NIR2
...
* **विकल्प**:
  ...
  * **TIFF (32-बिट, प्रतिशत)** - 32-बिट फ्लोटिंग-पॉइंट TIFF प्रतिशत के रूप में परावर्तन मान के साथ
  * **PNG (8-बिट)** - संपीड़ित 8-बिट PNG प्रारूप
  * **जेपीजी (8-बिट)** - संपीड़ित 8-बिट JPEG प्रारूप
* **डिफ़ॉल्ट**: TIFF (16-बिट)
* **विवरण**: संसाधित और कैलिब्रेटेड छवियों को सहेजने के लिए फ़ाइल प्रारूप का चयन करता है।
* **प्रारूप अनुशंसाएँ**:
  * **TIFF (16-बिट)**: वैज्ञानिक विश्लेषण और पेशेवर वर्कफ़्लो के लिए अनुशंसित। बिना किसी संपीड़न कलाकृतियों के अधिकतम डेटा गुणवत्ता को सुरक्षित रखता है। जीआईएस सॉफ्टवेयर में मल्टीस्पेक्ट्रल विश्लेषण और आगे की प्रक्रिया के लिए सर्वोत्तम।
  * **TIFF (32-बिट, प्रतिशत)**: उन वर्कफ़्लो के लिए सर्वोत्तम, जिनके लिए प्रतिशत (0-100%) के रूप में परावर्तन मानों की आवश्यकता होती है। रेडियोमेट्रिक माप के लिए अधिकतम परिशुद्धता प्रदान करता है।
  * **PNG (8-बिट)**: वेब देखने और सामान्य विज़ुअलाइज़ेशन के लिए अच्छा है। दोषरहित संपीड़न के साथ छोटे फ़ाइल आकार, लेकिन कम गतिशील रेंज।
...
* **विवरण**: अपने सेटिंग टेम्पलेट के लिए एक वर्णनात्मक नाम दर्ज करें और सेव आइकन पर क्लिक करें। भविष्य की परियोजनाओं में आसान पुन: उपयोग के लिए टेम्पलेट आपकी सभी मौजूदा प्रोजेक्ट सेटिंग्स (लक्ष्य का पता लगाना, प्रसंस्करण विकल्प, सूचकांक और निर्यात प्रारूप) को संग्रहीत करेगा।
* **उपयोग के मामले**:
  * विभिन्न कैमरा सिस्टम के लिए टेम्पलेट बनाएं (RGB, मल्टीस्पेक्ट्रल, NIR)
...
* **कैसे उपयोग करें**:
  ...
  2. एक टेम्पलेट नाम दर्ज करें (उदाहरण के लिए, "RedEdge Survey3 NDVI मानक")
...
* **डिफ़ॉल्ट (Windows)**: `C:\Users\[Username]\Chloros Projects`
* **डिफ़ॉल्ट (Linux)**: `~/.local/share/chloros/projects`
* **विवरण**: वर्तमान डिफ़ॉल्ट निर्देशिका दिखाता है जहां नए Chloros प्रोजेक्ट बनाए गए हैं। किसी भिन्न निर्देशिका का चयन करने के लिए संपादन आइकन पर क्लिक करें।
* **कब बदलना है**:
...
1. **सिस्टम डिफ़ॉल्ट** - Chloros द्वारा परिभाषित अंतर्निहित डिफ़ॉल्ट
...
4. **अपनी सेटिंग्स का दस्तावेजीकरण करें**: वर्णनात्मक टेम्पलेट नामों का उपयोग करें जो कैमरा सिस्टम, प्रसंस्करण प्रकार और इच्छित उपयोग को इंगित करते हैं (उदाहरण के लिए, "Survey3\_RGB\_NDVI\_कृषि")।
5. **निर्यात प्रारूप चयन**: अपने अंतिम उपयोग के आधार पर अपना निर्यात प्रारूप चुनें:
   * वैज्ञानिक विश्लेषण → TIFF (16-बिट या 32-बिट)
   * जीआईएस प्रोसेसिंग → TIFF (16-बिट)
   * त्वरित विज़ुअलाइज़ेशन → PNG (8-बिट)
   * वेब शेयरिंग → JPG (8-बिट)

***

Chloros में मल्टीस्पेक्ट्रल इंडेक्स पर अधिक जानकारी के लिए, [मल्टीस्पेक्ट्रल इंडेक्स फॉर्मूला](multispectral-index-formulas.md) पेज देखें।