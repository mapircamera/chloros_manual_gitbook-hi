...
इसका मतलब यह है कि आप हमारे कैमरे से जो भी छवि कैप्चर करते हैं, आप परावर्तन के लिए छवियों को कैलिब्रेट करने के लिए हमारे परावर्तन लक्ष्यों की एक तस्वीर का उपयोग कर सकते हैं, जैसे कि [T4-R50](https://www.mapir.camera/collections/calibration-targets/products/diffuse-reflectance-standard-calibration-target-package-t3-r50) या [T4-R125](https://www.mapir.camera/collections/multispectral-reflectance-reference-calibration-targets/products/diffuse-reflectance-standard-calibration-target-package-t4-r125)। एक बार कैलिब्रेट होने पर छवि में प्रत्येक पिक्सेल प्रतिशत परावर्तन के बराबर होता है।
