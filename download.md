...
### <a href='https://drive.google.com/file/d/1HjwrUY4M7HGxDbMybO7iPe_6JoHnUGr4/view?usp=drive_link' class='बटन प्राइमरी'>क्लोरोस यहां से डाउनलोड करें</a>
...
1. `क्लोरोस इंस्टालर - वर्तमान संस्करण.exe` फ़ाइल डाउनलोड करें
...
{%संकेत शैली='सफलता'%}
कमांड-लाइन एक्सेस के लिए इंस्टॉलर स्वचालित रूप से आपके सिस्टम PATH में `क्लोरोस-क्ली` जोड़ता है।
{%अंतसंकेत%}
